...
Laufender Stand aller Videos. Status-Werte nach [Produktionsworkflow](../docs/04-produktionsworkflow.md):
`Idee` → `Ausgewählt` → `Recherche` → `Skript` → `Material` → `Schnitt` → `Veröffentlicht`

## In Arbeit

| # | Format | Spiel | Finest Part | Status | Ordner |
|---|---|---|---|---|---|
| — | — | — | — | — | noch nichts ausgewählt |

## Vorgeschlagen (wartet auf Freigabe)

Aus der [Empfehlung im Ideen-Backlog](ideen-backlog.md#empfehlung-für-die-ersten-fünf-videos):
